		...
		<main>
			<div class="row">
				...
				<div id="content" class="col-80">
					<h1>In</h1>
					<div class="btn-ctr">
						<a href="like.php" class="btn left"><i class="fa fa-chevron-left"></i>Materi Sebelumnya</a>
						<a href="between.php" class="btn right">Materi Selanjutnya<i class="fa fa-chevron-right"></i></a>
					</div>
					<div class="line"></div>
					<section>
						<h2>In</h2>
						<p>In adalah Query yang digunakan untuk mencari data didalam database dengan mengelompokkan data berdasarkan kategori tertentu.</p>
						<h3>Sintax dasar</h3>
						<div class="syntax">
							<div class="syntax-inner">
								<p>SELECT * FROM nama_tabel WHERE nama_kolom IN ('kategori1','kategori2','kategori3')</p>
							</div>
						</div>
					</section>
					<div class="line"></div>
					<section id="example">
						...
						<p>Di bawah ini merupakan contoh query IN, silahkan ubah query jika anda ingin mencoba sendiri</p>
						<div id="sandbox">
							<textarea id="theQuery"rows="5" cols="33" required>select * from barang where jenis IN ('Minuman');</textarea>
